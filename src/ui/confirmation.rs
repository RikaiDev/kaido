...
impl ConfirmationModal {
    ...
    pub fn new(
        ...
        let confirmation_type = ConfirmationType::from_risk_and_environment(risk_level, environment);
    ...
    pub fn render(&self, frame: &mut Frame, area: Rect) {
        ...
        // Create main block
        let title = format!(" {} RISK - {} ENVIRONMENT ", 
        ...
        let env_text = vec![Line::from(Span::styled(
            format!("Context: {} | Namespace: {}", 
                ...
                "default"), // TODO: pass actual namespace
